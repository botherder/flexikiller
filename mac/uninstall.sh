#!/bin/bash
# NOTE: This is the uninstall script as provided by the FlexiSpy bundle.
#       The only changes made was to disable the removal of the entire
#       /log folder and disabled the errexit.
